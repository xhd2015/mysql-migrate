...
Filters to github.com/xhd2015/mysql-migrate/ product paths.
Skips cmd/ (thin process edge) so the table focuses on library packages.
...
MODULE_PREFIX = "github.com/xhd2015/mysql-migrate/"
